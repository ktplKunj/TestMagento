...
namespace Ktpl\Slider\Controller\Adminhtml\slider;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Ktpl_Slider::slider')
            ->addBreadcrumb(__('Ktpl Slider'), __('Ktpl Slider'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Ktpl\Slider\Model\Slider');
