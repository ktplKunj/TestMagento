...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('slider')->getId()) {
            return __("Edit Item '%1'", $this->escapeHtml($this->_coreRegistry->registry('slider')->getTitle()));
        } else {
            return __('New Item');
        }
    }
    ...
    {
        return $this->getUrl('slider/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
